...
class Concern extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('appel_offre_id, criteria_id', 'required'),
			array('appel_offre_id, criteria_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('appel_offre_id, criteria_id', 'safe', 'on'=>'search'),
		);
	}
        ...
        return array(
            ...
            'ECompositeUniqueKeyValidatable' => array(
                ...
                'uniqueKeys' => array(
                    'attributes' => 'criteria_id, appel_offre_id',
                    'errorMessage' => 'Vous avez déja efféctuer ce critère a cette appel d\'offre'
                )
            ),
        );
    }
    public function primaryKey() {
        return array('appel_offre_id', 'criteria_id');
    }
