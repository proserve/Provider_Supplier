<h1><?php echo Yii::t('app2', 'Select providers to delete from this project')?></h1>
...
<?php echo $form->select2Row($model, 'provider_id', array(
        'asDropDownList' => false,
        'options' => array(
            'tags' => Provider::model()->getProviderUpdateOptions(),
            'placeholder' => Yii::t('app2', 'Select providers to delete from this project'),
            'width' => '40%',
