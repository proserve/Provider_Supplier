<h1><?php echo Yii::t('app', 'Select evaluator to delete from this project')?></h1>
<?php
...
<?php echo $form->select2Row($model, 'evaluator_id', array(
        ...
        'options' => array(
            'tags' => Evaluator::model()->getEvaluatorUpdateOptions(),
            'placeholder' => Yii::t('app', 'Select evaluator to delete from this project'),
            'width' => '40%',
